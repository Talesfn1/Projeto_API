...
![sprint backlog](https://github.com/Talesfn1/Projeto_API/blob/main/BackLogIMG/BacklogS2.png)
# Priorização
## Sprint 1
...
- [x] Criação do Dashboard com evolução mensal por valor/peso da exportações;
